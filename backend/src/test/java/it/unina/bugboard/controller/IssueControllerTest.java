...
class IssueControllerTest {
    ...
    /**
     * TEST 1: creaIssue - Creazione valida con tutti i parametri corretti
     * Classe di equivalenza: Payload valido + Utente creatore esistente + Titolo univoco
     */
    @Test
    void testCreaIssue_PayloadValidoUtenteEsistente_Success() {
        ...
        Issue issueSalvata = new Issue(
            "Bug Login",
            "L'utente non riesce a effettuare il login",
            Priorita.high,
            Stato.Todo,
            Tipo.bug,
            creatore
    ...
    /**
     * TEST 2: creaIssue - Titolo vuoto (blank)
     * Classe di equivalenza: Titolo blank
     */
    @Test
    ...
    /**
     * TEST 3: creaIssue - Titolo null
     * Classe di equivalenza: Titolo null
     */
    @Test
    ...
    /**
     * TEST 4: creaIssue - Titolo già esistente
     * Classe di equivalenza: Titolo duplicato nel database
     */
    @Test
    void testCreaIssue_TitoloDuplicato_ThrowsAlreadyExistsException() {
        ...
        Issue issueEsistente = new Issue(
            "Bug Esistente",
            "Descrizione vecchia",
            Priorita.low,
            Stato.Todo,
    ...
    /**
     * TEST 5: creaIssue - Priorità non valida
     * Classe di equivalenza: Valore priorità non presente nell'enum
     */
    @Test
    ...
    /**
     * TEST 6: creaIssue - Stato non valido
     * Classe di equivalenza: Valore stato non presente nell'enum
     */
    @Test
    ...
    /**
     * TEST 7: creaIssue - Tipo non valido
     * Classe di equivalenza: Valore tipo non presente nell'enum
     */
    @Test
    ...
    /**
     * TEST 8: creaIssue - Utente creatore non esistente
     * Classe di equivalenza: idCreatore non presente nel database
     */
    @Test
    ...
    /**
     * TEST 9: creaIssue - Parsing case-insensitive degli enum
     * Classe di equivalenza: Valori enum con case misto vengono parsati correttamente
     */
    @Test
    ...
    /**
     * TEST 10: creaIssue - Priorità "none" (valore default)
     * Classe di equivalenza: Priorità null/blank viene convertita in "none"
     */
    @Test
    ...
    /**
     * TEST 11: creaIssue - Payload completamente null
     * Classe di equivalenza: Input null (validazione esplicita)
     */
    @Test
    void testCreaIssue_PayloadNull_ThrowsInvalidFieldException() {
        ...
        assertThrows(InvalidFieldException.class,
            () -> issueController.creaIssue(payloadNull));
        
        verify(issueDAO, never()).save(any());
    }

    /**
     * TEST 12: creaIssue - idCreatore null
     * Classe di equivalenza: Campo obbligatorio mancante
     */
    @Test
    ...
    /**
     * TEST 13: creaIssue - Verifica parsing "in_progress" con underscore
     * Classe di equivalenza: Stato con formato alternativo (underscore)
     */
    @Test
    ...
    /**
     * TEST 14 creaIssue - Descrizione null viene RIFIUTATA DAL MODELLO
     * Classe di equivalenza: Descrizione null (NON valida)
     */
    @Test
    void testCreaIssue_DescrizioneNull_ThrowsInvalidFieldException() {
        Map<String, Object> payload = new HashMap<>();
        payload.put("titolo", "Issue Senza Descrizione");
        payload.put("descrizione", null); // ❌ Il modello Issue lo rifiuta nel setter
        payload.put("priorita", "medium");
        payload.put("stato", "todo");
        payload.put("tipo", "bug");
        payload.put("idCreatore", 1);
    ...
    /**
     * TEST 15 NUOVO: creaIssue - Stato vuoto (empty string, non blank)
     * Valore di frontiera
     */
    @Test
    void testCreaIssue_StatoEmptyString_ThrowsInvalidFieldException() {
        ...
        payload.put("priorita", "medium");
        payload.put("stato", ""); // ❌ EMPTY STRING
        payload.put("tipo", "bug");
        payload.put("idCreatore", 1);
    ...
    /**
     * TEST 16 NUOVO: creaIssue - Priorità blank viene convertita in none
     * Verifica comportamento default
     */
    @Test
    void testCreaIssue_PrioritaBlank_ConvertsToNone() {
        ...
        payload.put("titolo", "Test");
        payload.put("descrizione", "Desc");
        payload.put("priorita", "   "); // BLANK (spazi)
        payload.put("stato", "todo");
        payload.put("tipo", "bug");
        payload.put("idCreatore", 1);
        ...
        when(issueDAO.findByTitolo(any())).thenReturn(Optional.empty());
        when(utenzaDAO.findById(1)).thenReturn(Optional.of(creatore));
        when(issueDAO.save(any())).thenReturn(new Issue());

        assertDoesNotThrow(() -> issueController.creaIssue(payload));
        
        verify(issueDAO).save(argThat(i -> i.getPriorita() == Priorita.none));
    }

    /**
     * TEST 17 NUOVO: creaIssue - Tipo blank dovrebbe fallire
     * Verifica validazione obbligatoria
     */
    @Test
