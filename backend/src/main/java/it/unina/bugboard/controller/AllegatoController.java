...
public class AllegatoController {
    ...
    // ===== ENDPOINT DELETE RIMOSSO =====
    // L'eliminazione degli allegati non è più consentita dall'interfaccia utente
    // Gli allegati possono essere eliminati solo tramite cancellazione cascata della Issue
